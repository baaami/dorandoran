...
func (r *UserRepository) InitDB() error {
	err := r.db.AutoMigrate(&User{}, &MatchFilter{})
	if err != nil {
...
// 유저 리스트 조회
func (r *UserRepository) GetUserList() ([]User, error) {
	var users []User
...
// 유저 조회 (SNS)
func (r *UserRepository) GetUserBySNS(snsType int, snsID string) (*User, error) {
	var user User
